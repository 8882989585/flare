...
object KryoSerialization extends App {
  ...
  private def readRDDAsKryoObject(ss: SparkSession): Unit = {
    ...
    rdd.saveAsObjectFile("/home/abhishek/workspace/flare/scala/spark/temp/spark/batch/rdd/kryoserialization")
  }

  private def readRDDFromKryoObject(ss: SparkSession): Unit = {
    val rdd = ss.sparkContext.objectFile[Person]("/home/abhishek/workspace/flare/scala/spark/temp/spark/batch/rdd/kryoserialization")
